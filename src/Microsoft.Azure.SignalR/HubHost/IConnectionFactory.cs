...
namespace Microsoft.Azure.SignalR
{
    ...
    {
        Task<ConnectionContext> ConnectAsync(ServiceEndpoint endpoint, TransferFormat transferFormat, string connectionId, CancellationToken cancellationToken = default);
